 ...
 */
    ...
    public void foundation() {
        ...
        drive.accelerateInchesBackward(2200, 25, 0, 3000);
        drive.accelerateInchesBackward(1500, 5, 0, 3000);
        latch.latchDown();
        teamUtil.pause(750);
        ...
        if (RED) {
            drive.accelerateInchesForward(2200, 25, 5, 3000);
            drive.accelerateInchesForward(1500, 11, 0, 3000);
        } else {
            drive.accelerateInchesForward(2200, 25, 355, 3000);
            drive.accelerateInchesForward(1500, 11, 0, 3000);
        }
...
/*        boolean RED = (teamUtil.alliance == teamUtil.Alliance.RED);
        ...
        if (RED) {
            drive.accelerateInchesForward(2200, 25, 185, 3000);
            drive.accelerateInchesForward(1500, 11, 180, 3000);
        } else {
            drive.accelerateInchesForward(2200, 25, 175, 3000);
            drive.accelerateInchesForward(1500, 11, 180, 3000);
        }
...
/*        boolean RED = (teamUtil.alliance == teamUtil.Alliance.RED);
        ...
        drive.accelerateInchesForward(2200, 69, RED ? 91 : 269, 6000);
...
//
        ...
        drive.accelerateInchesForward(-650, 9, 180, 4000);
        ...
        teamUtil.pause(500);
        drive.accelerateInchesForward(650, 5.5, 180, 4000);
        drive.rotateTo(RED ? 70 : 290);
        latch.latchUp();
        drive.newRotateTo(RobotDrive.RobotRotation.TOWARDS_DEPOT);
        drive.accelerateInchesForward(-2200, 75, RED ? 89 : 269, 6097);
...
//                    drive.newAccelerateInchesForward(-2200, 1, 0, 3000);
        ...
        drive.accelerateInchesForward(1100, 32, 0, 3000);
        liftSystem.grabAndStowNoWait(4500);
        teamUtil.pause(750);

        /////////////////////////////////////////////////////////
        // Deliver the first stone to the building side of the field
        drive.accelerateInchesForward(-2200, (RED ? 5 : 7), 0, 3000);
        ...
        switch (path) { // TODO: OR, we could go back to finding the tape line as we cross it and moving a set distance from there...
            case 3:
                distance = (RED ? 75.5 : 75.5);
                break;
            case 2:
                distance = (RED ? 83.5 : 83.5);
                break;// TODO RED + 8?
            case 1:
                distance = (RED ? 95.5 : 95.5);
                break;// TODO RED + 8?
        }
        drive.accelerateInchesForward(2200, distance, RED ? 268 : 88, 5000);
        drive.newRotateTo(RobotDrive.RobotRotation.TOWARDS_FIELD);
        drive.accelerateInchesForward(2200, RED ? 5 : 10, 0, 3000);
//        liftSystem.lift.slightlyMoveLiftBaseUp(1, 2000);
        liftSystem.grabber.slightlyOpenGrabber();

        drive.accelerateInchesForward(-2200, 7, 0, 3000);
//        liftSystem.lift.moveLiftBaseDownNoWait(0.5, 3000);
        liftSystem.grabber.grabberStow();
        drive.newRotateTo(RobotDrive.RobotRotation.TOWARDS_WALL);
        drive.accelerateInchesForward(-2200, 8.5, 180, 3000);
        ...
        if (RED) {
            drive.accelerateInchesForward(2200, 25, 185, 3000);
            drive.accelerateInchesForward(1000, 9.5, 180, 3000);
        } else {
            drive.accelerateInchesForward(2200, 25, 175, 3000);
            drive.accelerateInchesForward(1000, 9.5, 180, 3000);
        }
        ...
        drive.accelerateInchesForward(-1500, RED ? 26 : 25, 180, 3500);
...
//                    drive.newAccelerateInchesForward(-2200, 1, 0, 3000);
        ...
        switch (path) { // TODO: OR, we could go back to finding the tape line as we cross it and moving a set distance from there...
            case 3:
                distance = (RED ? 44.5 : 44.5);
                break;
            case 2:
                distance = (RED ? 52.5 : 52.5);
                break;// TODO RED + 8?
            case 1:
                distance = (RED ? 60.5 : 62.5);
                break;// TODO RED + 8?
        }
        drive.accelerateInchesForward(2200, distance, RED ? 268 : 88, 5000);
        ...
        if (!RED && path != 1) {
            drive.accelerateInchesForward(2200, 4, 0, 2000);
        }
...
//            drive.moveInchesRight(0.5, 18, 3000); //TODO: OUT OF ORDER AUTO
        ...
        if (RED) {
            drive.accelerateInchesForward(-2200, 1, 0, 5000);
        }
        ...
        switch (path) { // TODO: OR, we could go back to finding the tape line as we cross it and moving a set distance from there...
            ...
            case 2:
                distance = (RED ? 67 : 67);
                break;// TODO RED + 8?
//            case 1 : distance = (RED ? 60  :60); break;// TODO Need to think about this case carefully!
        }
        drive.accelerateInchesForward(2200, distance, RED ? 89 : 265.5, 5000); // TODO: It would be nice to combine this movement with the close to distance...it might just work...
        switch (path) {
            case 3:
            case 2:
                distance = (RED ? 13.5 : 13.5);
                break; // TODO RED - 8?
//            case 1 : distance = (RED ? 10.5  :0); break; // TODO Need to think about this case carefully!
        }
        ...
        if (useDistanceSensorsALot) {
            drive.moveToDistance(drive.frontLeftDistance, 5, 1500, 0, true, 4000);
            drive.accelerateInchesForward(2200, 7, 0, 5000);
            liftSystem.grabAndStowNoWait(4500);
            teamUtil.sleep(750);
            drive.accelerateInchesForward(-2200, (RED ? 5 : 5), 0, 5000);

        } else {
            drive.accelerateInchesForward(2200, 11, 0, 5000);
            liftSystem.grabAndStowNoWait(4500);
            teamUtil.sleep(750);
            drive.accelerateInchesForward(-2200, (RED ? 7 : 9), 0, 5000);
        }
        ...
        switch (path) { // TODO: OR, we could go back to finding the tape line as we cross it and moving a set distance from there...
            case 3:
                distance = (RED ? 66.5 : 66.5); //TODO: OUT OF ORDER AUTO: 78.5 both sides
                break;
            case 2:
                distance = (RED ? 70.5 : 70.5); //TODO: OUT OF ORDER AUTO: 82.5 both sides
                break;// TODO RED + 8?
            case 1:
                distance = (RED ? 60.5 : 60.5);
                break;// TODO RED + 8?
        }
        drive.accelerateInchesForward(2200, distance, RED ? 268 : 88, 5000);
